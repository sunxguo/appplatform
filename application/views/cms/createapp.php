    ...
    <div class="app-con">
		...
		<div class="app-main">
			...
			<div class="app-scroll" id="step1Div">
				<h3>APP名称</h3>
				<div>
					<input type="text" id="appName" placeholder="请输入1-10个字" class="inp-txt blackVal" onblur="checkAppName()" onkeyup="checkAppName()">
				...
				<div>
					<input type="text" placeholder="请输入1-4个字" class="inp-txt blackVal" id="displayWord" onblur="checkDisplayWord()" onkeyup="checkDisplayWord()">
			...
			<div class="app-scroll" id="step3Div" style="display:none;">
				...
				<div class="btn-center">
					<a id="prevbtn" class="btn120" href="Javascript:step(3,2);">上一步</a> <a href="Javascript:create()" id="nextbtn" class="btn120">创建</a>
				</div>
			</div>
		</div>
